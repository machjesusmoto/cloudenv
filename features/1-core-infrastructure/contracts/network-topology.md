...
| Expected IP | `172.93.48.55` (single public IPv4) |
...
| vmbr0 | Bridge | Public | WAN bridge, holds public IP `172.93.48.55/24` |
...
|-------------|---------|-----------|--------|---------|
| 0.0.0.0/0 | 172.93.48.1 | vmbr0 | 0 | Default route to internet |
| 172.93.48.0/24 | direct | vmbr0 | 0 | Public subnet |
...
```
                                    ...
                                    └─────────────────────┬───────────────────────┘
                                                          │
                                                          │ Public IPv4: 172.93.48.55
                                                          │
┌─────────────────────────────────────────────────────────┴─────────────────────────────────────────────────────────┐
│                                    PROXMOX VE HOST (Debian 13)                                                     │
│                                                                                                                    │
│  enp3s0 ────► vmbr0 (172.93.48.55/24) ◄────────────────────────────────────────────────────────────────────┐     │
│               │      Default gateway: 172.93.48.1                                                           │     │
│               │                                                                                             │     │
│               │                                                                                             │     │
...
- assert: proxmox.vmbr0.ip == "172.93.48.55"
